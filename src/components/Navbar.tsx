            ...
            {open && (
              ...
              >
                <div className="flex items-center gap-3 px-3 py-2 border-b border-gray-100">
                  <div className="relative w-14 h-11 rounded-full bg-green-100 flex items-center justify-center overflow-hidden">
                    {user.image ? (
                      <Image
                        src={user.image}
                        alt="User"
                ...
                <button className="flex items-center gap-2 w-full text-left px-3 py-3 hover:bg-red-50 rounded-lg text-gray-700 font-medium" type="button" onClick={()=>{
                    setOpen(false);
